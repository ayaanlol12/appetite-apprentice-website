...
import { Plane, MapPin, Phone, Mail, Clock, Star, ArrowRight, ShieldCheck, GraduationCap, Briefcase, Wallet } from "lucide-react";
...
function Home() {
  ...
  <div className="max-w-7xl mx-auto">
    <div className="text-center mb-14">
      ...
      <p className="text-gray-400 text-lg">
        Visit our aviation academy branches across India
      </p>
    </div>
    ...
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
      ...
      <div className="bg-zinc-900 rounded-3xl overflow-hidden border border-zinc-800">
        ...
        <div className="p-6">
          ...
          <p className="text-gray-400">
            Professional aviation training centre in Visakhapatnam.
          </p>
        </div>
      </div>
      ...
      <div className="bg-zinc-900 rounded-3xl overflow-hidden border border-zinc-800">
        ...
        <div className="p-6">
          ...
          <p className="text-gray-400">
            Professional aviation training centre in Rajahmundry.
          </p>
        </div>
      </div>
      ...
      <div className="bg-zinc-900 rounded-3xl overflow-hidden border border-zinc-800">
        ...
        <div className="p-6">
          ...
          <p className="text-gray-400">
            Aviation academy branch serving Vizag students.
          </p>
        </div>
      </div>
      ...
      <div className="bg-zinc-900 rounded-3xl overflow-hidden border border-zinc-800">
        ...
        <div className="p-6">
          ...
          <p className="text-gray-400">
            Main aviation training branch near Hyderabad airport.
          </p>
        </div>
      </div>
  ...
  <div className="max-w-3xl mx-auto">
    ...
    <form
      action="https://formsubmit.co/ayaan21shaik@gmail.com"
      method="POST"
      className="space-y-6"
    >
      <input
      ...
      <button
        type="submit"
        className="w-full rounded-2xl bg-yellow-500 text-black font-bold py-4 hover:bg-yellow-400 transition"
      >
        Submit Enquiry
      </button>
    </form>
      ...
      <div className="max-w-7xl mx-auto grid lg:grid-cols-12 gap-10 items-center">
        <div className="lg:col-span-6 relative animate-reveal">
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            <a
              href="#finder"
              className="inline-flex items-center gap-2 rounded-full gradient-sky text-primary-foreground px-6 py-3 font-semibold shadow-sky hover:opacity-90 transition"
            >
              Find my course <ArrowRight className="h-4 w-4" />
            </a>
            <a
              href="#visit"
              className="inline-flex items-center gap-2 rounded-full border border-border bg-card px-6 py-3 font-semibold hover:bg-accent hover:text-accent-foreground transition"
            >
              Book a campus visit
            </a>
          </div>
        ...
        <div className="lg:col-span-6 relative">
          <div className="relative rounded-3xl overflow-hidden shadow-sky">
            <img
              src={heroImg}
              alt="Commercial airliner taking off into a golden sunrise"
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {courses.map((c, i) => (
            <article
              key={c.slug}
              className="group relative rounded-3xl overflow-hidden bg-card border border-border shadow-soft hover:shadow-sky transition-all duration-500 hover:-translate-y-1"
            ...
            >
              <div className="grid sm:grid-cols-5">
                <div className="relative sm:col-span-2 h-56 sm:h-auto overflow-hidden">
                  ...
                  <span className="absolute top-3 left-3 text-[10px] font-mono uppercase tracking-widest bg-card/90 backdrop-blur px-2 py-1 rounded">
                    {c.duration}
                  </span>
                </div>
      ...
      <div className="relative max-w-7xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
          {placedAt.map((p, i) => (
            <div
              key={p.name}
              className="group relative rounded-2xl border border-primary-foreground/10 bg-primary-foreground/5 backdrop-blur p-5 hover:bg-primary-foreground/10 transition"
            ...
            >
              ...
              <p className="text-xs text-primary-foreground/50 mt-3 border-t border-primary-foreground/10 pt-3">
                {p.airport}
              </p>
            </div>
          ))}
      ...
      <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
        <div className="relative animate-reveal">
          <div className="rounded-3xl overflow-hidden shadow-sky">
            <img
              src={terminalImg}
              alt="Modern airport terminal at golden hour with airliner outside"
              loading="lazy"
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="columns-1 md:columns-2 lg:columns-3 gap-6 [column-fill:_balance]">
          {reviews.map((r, i) => (
            <figure
              key={i}
              className="break-inside-avoid mb-6 rounded-2xl border border-border bg-card p-6 shadow-soft hover:shadow-sky hover:-translate-y-0.5 transition"
            >
      ...
      <div className="max-w-6xl mx-auto rounded-3xl overflow-hidden gradient-sky text-primary-foreground shadow-sky relative">
        ...
        <div className="relative grid md:grid-cols-2 gap-10 p-10 md:p-16" id="enquire">
          <div>
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <a
                href="tel:+919063028362"
                className="inline-flex items-center gap-2 rounded-full gradient-gold text-accent-foreground px-6 py-3 font-semibold shadow-gold hover:opacity-90 transition animate-pulse-ring"
              >
                <Phone className="h-4 w-4" /> Call admissions
              </a>
              <a
                href="mailto:calibreaviation@gmail.com"
                className="inline-flex items-center gap-2 rounded-full border border-primary-foreground/40 px-6 py-3 font-semibold hover:bg-primary-foreground/10 transition"
              >
